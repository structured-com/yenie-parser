# ruff: noqa
# Derived from CiscoTestAutomation/genieparser show_run.py.
...
from yenie_parser._genie_compat import Any, And, Common, Default, ListOf, MetaParser, Optional, Or, Schema, Use

GENIE_SOURCE_REPOSITORY = "https://github.com/CiscoTestAutomation/genieparser"
GENIE_SOURCE_PATH = "src/genie/libs/parser/iosxe/show_run.py"
...
SUPPORTED_COMMANDS = _flatten_cli_commands(
    ShowRunPolicyMap.cli_command,
    ShowRunInterface.cli_command,
    ShowRunInterfaceAllSectionInterface.cli_command,
    ShowRunMdnsSd.cli_command,
    ShowRunAllSectionInterface.cli_command,
    ShowRunningAAAUserName.cli_command,
    ShowRunningConfigAAAUsername.cli_command,
    ShowRunningConfigFlowMonitor.cli_command,
    ShowRunningConfigAAA.cli_command,
    ShowRunningConfigNve.cli_command,
    ShowRunRoute.cli_command,
    ShowRunSectionBgp.cli_command,
    ShowRunSectionVrfDefinition.cli_command,
    ShowRunSectionMacAddress.cli_command,
    ShowRunningConfigAllClassMap.cli_command,
    ShowRunningConfigAAARadiusServer.cli_command,
    ShowRunningConfigVrf.cli_command,
    ShowRunSectionAlarm.cli_command,
)
