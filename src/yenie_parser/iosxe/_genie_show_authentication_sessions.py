# ruff: noqa
# Derived from CiscoTestAutomation/genieparser show_authentication_sessions.py.
...
GENIE_SOURCE_PATH = "src/genie/libs/parser/iosxe/show_authentication_sessions.py"
GENIE_SOURCE_REF = "main"
GENIE_SOURCE_COMMIT = "07d9c0fd6fba168086b86bd4a38ca4037fbd5c19"
...
SUPPORTED_COMMANDS = _flatten_cli_commands(
    ShowAuthenticationSessions.cli_command,
    ShowAuthenticationSessionsInterfaceDetails.cli_command,
    ShowAuthenticationSessionsMACDetails.cli_command,
    AuthenticationDisplayConfigMode.cli_command,
    ShowAccessSessionsInfo.cli_command,
    ShowSessions.cli_command,
    ShowAuthenticationMacDetails.cli_command,
    ShowAuthenticationSessionInterface.cli_command,
    ShowAuthenticationSessionsSessionId.cli_command,
    ShowAuthenticationSessionInterfaceSwitch.cli_command,
    ShowAuthenticationSessionMethod.cli_command,
)
