# ruff: noqa
# Derived from CiscoTestAutomation/genieparser show_fdb.py.
...
from yenie_parser._genie_compat import Any, Common, MetaParser, Optional, Or

GENIE_SOURCE_REPOSITORY = "https://github.com/CiscoTestAutomation/genieparser"
GENIE_SOURCE_PATH = "src/genie/libs/parser/iosxe/show_fdb.py"
...
SUPPORTED_COMMANDS = _flatten_cli_commands(
    ShowMacAddressTable.cli_command,
    ShowMacAddressTableAgingTime.cli_command,
    ShowMacAddressTableLearning.cli_command,
    ShowMacAddressMacVlan.cli_command,
    ShowMacAddressTableNotificationChange.cli_command,
    ShowMacAddressTableNotificationChangeInterface.cli_command,
)
