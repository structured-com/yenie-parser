# ruff: noqa
# Derived from CiscoTestAutomation/genieparser show_routing.py.
...
from yenie_parser._genie_compat import Any, MetaParser, Optional, Schema

GENIE_SOURCE_REPOSITORY = "https://github.com/CiscoTestAutomation/genieparser"
GENIE_SOURCE_PATH = "src/genie/libs/parser/iosxe/show_routing.py"
...
class ShowIpRouteDistributor(MetaParser):
    ...
    def cli(self, vrf=None, route=None, protocol=None, output=None, timeout=60):
        ...
        if (route or protocol) in self.protocol_set or (not route and not protocol):
            ...
            return parser.cli(output=out)

        else:
            parser = ShowIpRouteWord()
            self.schema=parser.schema
            return parser.cli(output=out)
...
SUPPORTED_COMMANDS = _flatten_cli_commands(
    ShowIpRouteDistributor.cli_command,
    ShowIpv6RouteDistributor.cli_command,
    ShowIpv6RouteUpdated.cli_command,
    ShowIpCef.cli_command,
    ShowIpv6Cef.cli_command,
    ShowIpCefDetail.cli_command,
    ShowIpRouteSummary.cli_command,
    ShowIpCefInternal.cli_command,
    ShowIpv6CefInternal.cli_command,
    ShowIpv6RouteSummary.cli_command,
    ShowIpRouteSupernet.cli_command,
    ShowRibClient.cli_command,
    ShowBannerMotd.cli_command,
)
