# ruff: noqa
# Derived from CiscoTestAutomation/genieparser show_cts.py.
# Genie imports and device execution dependencies are replaced for Yenie Parser.
import re

from yenie_parser._genie_compat import Any, ListOf, MetaParser, Optional, oper_fill_tabular

GENIE_SOURCE_REPOSITORY = "https://github.com/CiscoTestAutomation/genieparser"
GENIE_SOURCE_PATH = "src/genie/libs/parser/iosxe/show_cts.py"
GENIE_SOURCE_REF = "fe78fb29ac3c9e44a854ff34beb72d4ec9242bb0"
GENIE_SOURCE_COMMIT = "fe78fb29ac3c9e44a854ff34beb72d4ec9242bb0"
...
SUPPORTED_COMMANDS = _flatten_cli_commands(
    ShowCtsSxpConnectionsBrief.cli_command,
    ShowCtsPacs.cli_command,
    ShowCtsRoleBasedCounters.cli_command,
    ShowCts.cli_command,
    ShowCtsEnvironmentData.cli_command,
    ShowCtsRbacl.cli_command,
    ShowCtsRoleBasedPermissions.cli_command,
    ShowCtsWirelessProfilePolicy.cli_command,
    ShowCtsApSgtInfo.cli_command,
    ShowCtsInterface.cli_command,
    ShowCtsRolebasedSgtMapIp.cli_command,
    ShowCtsRoleBasedSgtMapAll.cli_command,
    ShowCtsSxpConnections.cli_command,
    ShowCtsSxpSgtMapBrief.cli_command,
    ShowCtsServerList.cli_command,
    ShowCtsPolicyServerStatistics.cli_command,
    ShowCtsPolicyServerDetails.cli_command,
    ShowPlatformSoftwareFedActiveAclSgacl.cli_command,
    ShowCtsInterfaceSummary.cli_command,
    ShowCtsPolicySgt.cli_command,
    ShowCtsHaSyncStatus.cli_command,
    ShowCtsProvisioningQueue.cli_command,
    ShowCtsCredentials.cli_command,
    ShowCtsSxpSgtMap.cli_command,
    ShowCtsSxpExportImportGroupDetailed.cli_command,
    ShowCtsKeyStore.cli_command,
)
