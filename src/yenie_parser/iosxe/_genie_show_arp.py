# ruff: noqa
# Derived from CiscoTestAutomation/genieparser show_arp.py.
...
from yenie_parser._genie_compat import Any, Common, MetaParser, Optional

GENIE_SOURCE_REPOSITORY = "https://github.com/CiscoTestAutomation/genieparser"
GENIE_SOURCE_PATH = "src/genie/libs/parser/iosxe/show_arp.py"
...
SUPPORTED_COMMANDS = _flatten_cli_commands(
    ShowArp.cli_command,
    ShowIpArp.cli_command,
    ShowIpArpSummary.cli_command,
    ShowIpTraffic.cli_command,
    ShowArpApplication.cli_command,
    ShowArpSummary.cli_command,
    ShowIpArpInspectionVlan.cli_command,
    ShowAdjacencySummary.cli_command,
    ShowIpArpInspectionStatisticsVlan.cli_command,
    ShowIpArpInspectionInterfaces.cli_command,
    ShowIpArpInspectionLog.cli_command,
)
