# ruff: noqa
# Derived from CiscoTestAutomation/genieparser show_device_tracking.py.
...
GENIE_SOURCE_PATH = "src/genie/libs/parser/iosxe/show_device_tracking.py"
GENIE_SOURCE_REF = "main"
...
SUPPORTED_COMMANDS = _flatten_cli_commands(
    ShowDeviceTrackingDatabase.cli_command,
    ShowDeviceTrackingDatabaseInterface.cli_command,
    ShowDeviceTrackingPolicies.cli_command,
    ShowDeviceTrackingPolicy.cli_command,
    ShowIpv6RaGuardPolicy.cli_command,
    ShowIpv6SourceGuardPolicy.cli_command,
    ShowDeviceTrackingCountersVlan.cli_command,
    ShowDeviceTrackingDatabaseMac.cli_command,
    ShowDeviceTrackingDatabaseMacMac.cli_command,
    ShowDeviceTrackingDatabaseMacMacDetails.cli_command,
    ShowDeviceTrackingCountersInterface.cli_command,
    ShowDeviceTrackingEvents.cli_command,
    ShowDeviceTrackingFeatures.cli_command,
    ShowDeviceTrackingDatabaseMacDetails.cli_command,
    ShowDeviceTrackingMessages.cli_command,
    ShowDeviceTrackingDatabaseInterfaceCount.cli_command,
    ShowDeviceTrackingCapturePolicy.cli_command,
    ShowDeviceTrackingDatabaseDetails.cli_command,
    ShowDeviceTrackingMessagesDetailedNum.cli_command,
)
