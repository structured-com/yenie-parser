# ruff: noqa
# Derived from CiscoTestAutomation/genieparser show_aaa.py.
...
from yenie_parser._genie_compat import And, Any, Default, MetaParser, Optional, Or, Schema, Use

GENIE_SOURCE_REPOSITORY = "https://github.com/CiscoTestAutomation/genieparser"
GENIE_SOURCE_PATH = "src/genie/libs/parser/iosxe/show_aaa.py"
GENIE_SOURCE_REF = "b4b31e251b2c40ab92b9849ed985a02e647ef27c"
GENIE_SOURCE_COMMIT = "b4b31e251b2c40ab92b9849ed985a02e647ef27c"
...
SUPPORTED_COMMANDS = _flatten_cli_commands(
    ShowAAServers.cli_command,
    ShowAAAUserAll.cli_command,
    ShowAaaFqdnAll.cli_command,
    ShowAAACacheGroup.cli_command,
    ShowAAACommonCriteraPolicy.cli_command,
    ShowAAAMethodList.cli_command,
    ShowAaaDeadCriteriaRadius.cli_command,
    ShowAaaSessions.cli_command,
    ShowAaaMemory.cli_command,
)
