# ruff: noqa
# Derived from CiscoTestAutomation/genieparser show_cdp.py.
...
GENIE_SOURCE_PATH = "src/genie/libs/parser/iosxe/show_cdp.py"
GENIE_SOURCE_REF = "main"
GENIE_SOURCE_COMMIT = "047f0a6d6cccb0d9564682457b0ed9a371494e4a"
...
SUPPORTED_COMMANDS = _flatten_cli_commands(
    ShowCdpNeighbors.cli_command,
    ShowCdpNeighborsDetail.cli_command,
    ShowCdpTraffic.cli_command,
    ShowCdpInterface.cli_command,
    ShowCdpEntry.cli_command,
    ShowCdp.cli_command,
)
